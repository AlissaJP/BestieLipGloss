...
export default function Footer() {
  ...
  return (
    <footer className="bg-white border-t border-pink-100 pt-12 pb-6">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-10">
          {/* Brand */}
          <div>
            <h3 className="font-greatvibes text-3xl text-primary mb-2">Bestie LipGloss</h3>
            <p className="font-lato text-sm text-gray-500 leading-relaxed">{t.footer.tagline}</p>
          </div>
          ...
          <div>
            ...
            <div className="flex gap-4">
              ...
              <a href="#" target="_blank" rel="noopener noreferrer"
                ...
                <span className="font-lato text-xs text-gray-400 group-hover:text-primary transition-colors">TikTok</span>
              </a>
            </div>
          </div>
        ...
        <div className="border-t border-pink-100 pt-6 flex flex-col sm:flex-row items-center justify-between gap-2">
          <p className="font-lato text-xs text-gray-400">
            © 2024 Bestie LipGloss · {t.footer.rights}{' '}
            <Heart size={11} className="inline text-primary" aria-hidden="true" />
          </p>
          <p className="font-lato text-xs text-gray-400">{t.footer.natural}</p>
        </div>
      </div>
    </footer>
  );
